...
CREATE DATABASE netflix WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'en_US.UTF-8';
...
--
-- Name: hzu; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.hzu (
    flg character(50)
);


ALTER TABLE public.hzu OWNER TO postgres;
...
\.
COPY public.actor (actor_id, first_name, last_name, last_update) FROM '$$PATH$$/3582.dat';
...
\.
COPY public.address (address_id, address, address2, district, city_id, postal_code, phone, last_update) FROM '$$PATH$$/3590.dat';
...
\.
COPY public.category (category_id, name, last_update) FROM '$$PATH$$/3584.dat';
...
\.
COPY public.city (city_id, city, country_id, last_update) FROM '$$PATH$$/3592.dat';
...
\.
COPY public.country (country_id, country, last_update) FROM '$$PATH$$/3594.dat';
...
\.
COPY public.customer (customer_id, store_id, first_name, last_name, email, address_id, activebool, create_date, last_update, active) FROM '$$PATH$$/3580.dat';
...
\.
COPY public.film (film_id, title, description, release_year, language_id, rental_duration, rental_rate, length, replacement_cost, rating, last_update, special_features, fulltext) FROM '$$PATH$$/3586.dat';
...
\.
COPY public.film_actor (actor_id, film_id, last_update) FROM '$$PATH$$/3587.dat';
...
\.
COPY public.film_category (film_id, category_id, last_update) FROM '$$PATH$$/3588.dat';

--
-- Data for Name: hzu; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.hzu (flg) FROM stdin;
\.
...
\.
COPY public.inventory (inventory_id, film_id, store_id, last_update) FROM '$$PATH$$/3596.dat';
...
\.
COPY public.language (language_id, name, last_update) FROM '$$PATH$$/3598.dat';
...
\.
COPY public.payment (payment_id, customer_id, staff_id, rental_id, amount, payment_date) FROM '$$PATH$$/3600.dat';
...
\.
COPY public.rental (rental_id, rental_date, inventory_id, customer_id, return_date, staff_id, last_update) FROM '$$PATH$$/3602.dat';
...
\.
COPY public.staff (staff_id, first_name, last_name, address_id, email, store_id, active, username, password, last_update, picture) FROM '$$PATH$$/3604.dat';
...
\.
COPY public.store (store_id, manager_staff_id, address_id, last_update) FROM '$$PATH$$/3606.dat';
